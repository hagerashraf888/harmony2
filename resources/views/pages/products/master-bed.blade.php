    ...
    <div class="gallery">
        ...
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/01-master-bed/01-cloud.jpg')}}">
                <h4> Cloud </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/01-master-bed/02-beam.jpg')}}">
                <h4> Beam </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/01-master-bed/03-lady.jpg')}}">
                <h4> Lady </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/01-master-bed/04-cala.jpg')}}">
                <h4> Cala </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/01-master-bed/05-anctuary.jpg')}}">
                <h4> Anctuary </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/01-master-bed/06-jane.jpg')}}">
                <h4> Jane </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/01-master-bed/07-candle.jpg')}}">
                <h4> Candle </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/01-master-bed/08-lima.jpg')}}">
                <h4> Lima </h4>
