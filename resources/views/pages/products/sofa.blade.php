    ...
    <div class="gallery">
        ...
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/05-sofa/01-salax.jpg')}}">
                <h4> Salax </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/05-sofa/02-derhan.jpg')}}">
                <h4> Derhan </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/05-sofa/03-richmond.jpg')}}">
                <h4> Richmond </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/05-sofa/04-dallas.jpg')}}">
                <h4> Dallas </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/05-sofa/05-nioby.jpg')}}">
                <h4> Nioby </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/05-sofa/06-estilo.jpg')}}">
                <h4> Estilo </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/05-sofa/07-handa.jpg')}}">
                <h4> Handa </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/05-sofa/08-nesta.jpg')}}">
                <h4> Nesta </h4>
