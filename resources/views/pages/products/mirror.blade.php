    ...
    <div class="gallery">
        ...
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/04-mirror/01-clory.jpg')}}">
                <h4> CLory </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/04-mirror/02-primrose.jpg')}}">
                <h4> Primrose </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/04-mirror/03-lighted.jpg')}}">
                <h4> Lighted </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/04-mirror/04-access.jpg')}}">
                <h4> Access </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/04-mirror/05-diy.jpg')}}">
                <h4> Dily </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/04-mirror/06-soles.jpg')}}">
                <h4> Soles </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/04-mirror/07-etsy.jpg')}}">
                <h4> Etsy </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/04-mirror/08-dazzling.jpg')}}">
                <h4> Dazzling </h4>
