    ...
    <div class="gallery">
        ...
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/03-closet/01-glory.jpg')}}">
                <h4> GLory </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/03-closet/02-bless.jpg')}}">
                <h4> Bless </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/03-closet/03-inspiring.jpg')}}">
                <h4> Inspiring </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/03-closet/04-creative.jpg')}}">
                <h4> Creative </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/03-closet/05-aberto.jpg')}}">
                <h4> Aberto </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/03-closet/06-lisa.jpg')}}">
                <h4> Lisa </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/03-closet/07-cloffice.jpg')}}">
                <h4> Cloffice </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/03-closet/08-kyal.jpg')}}">
                <h4> Kyal </h4>
