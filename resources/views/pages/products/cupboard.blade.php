    ...
    <div class="gallery">
        ...
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/08-cupboard/01-laundry.jpg')}}">
                <h4> Laundry </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/08-cupboard/02-pantry.jpg')}}">
                <h4> Pantry </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/08-cupboard/03-smart.jpg')}}">
                <h4> Smart </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/08-cupboard/04-tiny.jpg')}}">
                <h4> Tiny </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/08-cupboard/05-linen.jpg')}}">
                <h4> Linen </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/08-cupboard/06-mipo.jpg')}}">
                <h4> Mipo </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/08-cupboard/07-canty.jpg')}}">
                <h4> Canty</h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/08-cupboard/08-renov.jpg')}}">
                <h4> Renov </h4>
