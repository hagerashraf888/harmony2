...
<html>
    ...
    <header>
        <div class="banner">
            ...
            <h1 data-aos="fade-down-right"> CHAIRS </h1>
        </div>
    ...
    <!-- gallery -->
    <div class="gallery">
        <h5 data-aos="fade-down-right"> CHAIRS </h5>
        <hr data-aos="fade-right">
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/06-chair/01-hanging.jpg')}}">
                <h4> Hanging </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/06-chair/02-retro.jpg')}}">
                <h4> Retro </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/06-chair/03-boho.jpg')}}">
                <h4> Boho </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/06-chair/04-accent.jpg')}}">
                <h4> Accent </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/06-chair/05-lanalou.jpg')}}">
                <h4> Lanalou </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/06-chair/06-luxur.jpg')}}">
                <h4> Luxur </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/products/06-chair/07-snuggle.jpg')}}">
                <h4> Snuggle </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/products/06-chair/08-show.jpg')}}">
                <h4> Show </h4>
