    ...
    <div class="gallery">
        ...
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/04-dinning-room/01-libra.jpg')}}">
                <h4> Libra </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/04-dinning-room/02-shiny.jpg')}}">
                <h4> Shiny </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/04-dinning-room/03-bonita.jpg')}}">
                <h4> Bonita </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/04-dinning-room/04-nordic.jpg')}}">
                <h4> Nordic </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/04-dinning-room/05-melanie.jpg')}}">
                <h4> Melanie </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/04-dinning-room/06-raft.jpg')}}">
                <h4> Raft </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/04-dinning-room/07-lovely.jpg')}}">
                <h4> Lovely </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/04-dinning-room/08-glory.jpg')}}">
                <h4> GLory </h4>
