...
<html>
    ...
    <header>
        <div class="banner">
            ...
            <h1 data-aos="fade-down-right"> MASTER BEDROOMS </h1>
        </div>
    ...
    <!-- gallery -->
    <div class="gallery">
        <h5 data-aos="fade-down-right"> MASTER BEDROOMS </h5>
        <hr data-aos="fade-right">
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/01-master-room/01-ceiling.jpg')}}">
                <h4> Ceiling </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/01-master-room/03-bohemian.jpg')}}">
                <h4> Bohemian </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/01-master-room/04-cozy.jpg')}}">
                <h4> Cozy </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/01-master-room/05-gothic.jpg')}}">
                <h4> Gothic </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/01-master-room/06-florence.jpg')}}">
                <h4> Florence </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/01-master-room/07-vida.jpg')}}">
                <h4> Vida </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/01-master-room/08-pure.jpg')}}">
                <h4> Pure </h4>
