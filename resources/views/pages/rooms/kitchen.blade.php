    ...
    <div class="gallery">
        ...
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/05-kitchen/01-vibe.jpg')}}">
                <h4> Vibe </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/05-kitchen/02-swoon.jpg')}}">
                <h4> Swoon </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/05-kitchen/03-berlin.jpg')}}">
                <h4> Berlin </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/05-kitchen/04-kuche.jpg')}}">
                <h4> Kuche </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/05-kitchen/05-express.jpg')}}">
                <h4> Express </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/05-kitchen/06-wood.jpg')}}">
                <h4> Wood </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/05-kitchen/07-venice.jpg')}}">
                <h4> Venice </h4>
