    ...
    <div class="gallery">
        ...
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/02-single-room/01-chic.jpg')}}">
                <h4> Chic </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/02-single-room/02-quarto.jpg')}}">
                <h4> Quatro </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/02-single-room/03-active.jpg')}}">
                <h4> Active </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/02-single-room/04-rain.jpg')}}">
                <h4> Rain </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/02-single-room/05-pins.jpg')}}">
                <h4> Pins </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/02-single-room/06-bliss.jpg')}}">
                <h4> Bliss </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/02-single-room/07-momento.jpg')}}">
                <h4> Momento </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/02-single-room/08-ciel.jpg')}}">
                <h4> Ciel </h4>
