    ...
    <div class="gallery">
        ...
        <div class="all">
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/03-living-room/01-dream.jpg')}}">
                <h4> Dream </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/03-living-room/02-ciro.jpg')}}">
                <h4> Ciro </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/03-living-room/03-imperia.jpg')}}">
                <h4> Imperia </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms/03-living-room/05-sila.jpg')}}">
                <h4> Sila </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/03-living-room/06-toscala.jpg')}}">
                <h4> Toscala </h4>
            ...
            <div class="card" data-aos="flip-up">
                <img src="{{ asset('images/rooms//03-living-room/07-stark.jpg')}}">
                <h4> Stark </h4>
            ...
            <div class="card" data-aos="flip-down">
                <img src="{{ asset('images/rooms/03-living-room/08-pavia.jpg')}}">
                <h4> Pavia </h4>
